...
const UpdateBusinessHours = "/UpdateBusinessHours";
...
export default {
  ...
  updateAppointment(payload: any) {
    return Repository.post(`${updateAppointment}`, {
      ...payload,
      business_id: fakeID,
    });
  },
  ...
  UpdateBusinessHours(payload: any) {
    return Repository.post(`${UpdateBusinessHours}`, {
      ...payload,
      business_id: fakeID,
    });
  },
