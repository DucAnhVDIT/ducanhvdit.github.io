...
function ExistingInfo({
  ...
  const handleUpdateAppointment = () => {
    calendarRepository
      .addAppointment(updateAppointmentRequest)
      .then((res) => {
  ...
  return (
    <div>
      <Slideover className="hidden sm:block" open={isOpen} onClose={onClose}>
          ...
          <Slideover.Description>
            ...
            <div className="flex justify-start mb-5">
              <Button
                variant="instagram"
                type="button"
                className={`border-none w-28 cursor-pointer rounded-full ${
                  activeTab === "info"
